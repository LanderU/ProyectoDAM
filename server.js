...
app.get("/matriculacion/:fecha", function (req, res) {
    ...
    if (dias > 30){
      ...
      var respuesta = [
          {
              text: "Aún queda más de un mes para poder hacer la matrícula.",
          }
      ];
      ...
      var respuesta = [
          {
              text: "Sólo quedan: " + dias + ", para hacer la matricula.",
          }
      ];
